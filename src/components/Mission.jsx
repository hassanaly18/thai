...
//       {/* Grid Container - Removed gap-4 */}
//       <div className="grid grid-cols-2 max-w-5xl mx-auto border border-gray-100 shadow-xl">
//         {/* Top Left - Mission */}
...
//       <div className="grid grid-cols-2 max-w-5xl mx-auto border border-gray-100 shadow-xl overflow-hidden">
//         {/* Top Left - Mission */}
