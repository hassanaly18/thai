        ...
        <div className="col-span-12 lg:col-span-8 space-y-6">
          ...
          <section className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-6">
              We provide a complete travel experience.
            </p>
        ...
        <aside className="col-span-12 lg:col-span-4 space-y-6">
              ...
              {[
                ...
                <li key={index}>
                  ...
                  <p className="text-gray-600 text-sm">
                    Quality service for an unforgettable experience.
                  </p>
                </li>
              ))}
            </ul>
          ...
          <section className="bg-[#312F93] rounded-lg p-6 text-white">
            ...
            <ul className="space-y-2">
              {[
                {
                  href: "mailto:info@destinationtoparadise.com",
                  label: "info@destinationtoparadise.com",
                },
                { href: "tel:+66992262260", label: "+66 992262260" },
                {
                  href: "https://g.co/kgs/PVQAP5L",
                  label:
                    "🏠 895 Phatthanakan 29 Alley, Khwaeng Suan Luang, Suan Luang, Bangkok 10250, Thailand.",
                },
              ].map((contact, index) => (
                <li key={index}>
